...
enum TemplateLibrary {
    ...
    static let sleepyVoyage = StoryTemplate(
        ...
        pages: [
            ...
            "They sailed past {setting}, where everything was already asleep. The waves rocked the boat slowly. Or were they clouds? One... two... one... two...",
    ...
    static let littleLostFriend = StoryTemplate(
        ...
        pages: [
            ...
            "The tiny guest rode on {companion}'s back, holding on tight. Along the way it sniffled, so {name} told it about {treasure}, and its eyes went wide with wonder, and it forgot all about its worries.",
            "Past {setting} they went, step by soft step. The evening air smelled like grass and stars. The tiny guest began to hum {sound}, but happier now, a going-home sort of hum.",
            "And there it was: a tiny door under a tiny hill, with a warm light inside and a family of tiny creatures waving. The smallest guest hugged {name}'s thumb, which was the biggest hug it could manage.",
