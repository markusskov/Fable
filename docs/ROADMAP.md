...
- [ ] **48-hour language sprint (owner green-lit 2026-07-23), after nb-NO infra lands:** de-DE ✅ (#27), es-ES ✅ (#28), fr-FR ✅ (evening session 2026-07-23: full catalog with French typography incl. narrow no-break spaces, three-template shelf with contraction-safe {setting} frames and uniformly feminine pronoun-referenced treasure pools, fr gate vocabulary with homonym care: bête/nulle/battre/cri excluded, "Cric, crac" end marker, store pack metadata-fr.md); remaining: it-IT, pt-BR
