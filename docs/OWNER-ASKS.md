...
3. **Submission day — everything else is done.** Attach build 3 to version 1.0, ensure the submission's item list includes BOTH Fable+ subscriptions (stage them via Add for Review on the group page first), set release to **Manual**, press Add for Review. Trial verified live on TestFlight (yearly-only, 7 days) 2026-07-23.
