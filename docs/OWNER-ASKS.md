...
4. **ASO title decision for v1.2 — 5 minutes, real installs at stake.**
   Competitive research (docs/appstore/aso-competitive-review-2026-08.md,
   2026-08-01) found every competitor in our niche maxes the 30-char title
   with keywords ("Oscar Bedtime Stories for Kids", "Little Stories: Bedtime
   Books", "Moshi Kids: Sleep, Relax, Play") while we use 13 ("Fable
   Bedtime"), and that "Fable" alone is contested by a cluster of lookalike
   apps plus the big Fable book-club app. Recommended: rename to **"Fable
   Bedtime Stories for Kids"** (exactly 30, keeps the Fable Bedtime brand
